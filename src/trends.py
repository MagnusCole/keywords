...
class TrendsAnalyzer:
    ...
    def get_trend_data(self, keywords: List[str], timeframe: str = 'today 12-m', 
                      geo: str = 'ES') -> Dict[str, Dict]:
        """
    ...
    def _process_keyword_batch(self, keywords: List[str], timeframe: str, 
                              geo: str) -> Dict[str, Dict]:
    ...
    def _analyze_keyword_trends(self, keyword: str, interest_data: pd.DataFrame,
                               regional_data: pd.DataFrame, 
                               related_queries: Dict) -> Dict:
            ...
            for keyword in keywords:
                if keyword in interest_data.columns:
                    ...
                    comparison[keyword] = {
                        ...
                        'consistency': 1 - (float(values.std()) / float(values.mean())) if values.mean() > 0 else 0
                    }
