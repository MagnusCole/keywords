...
from src.core.standardized_scoring import StandardizedScorer, ScoringConfig
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            if clusters:  # May return None with small dataset
                ...
                assert all(hasattr(item, "cluster_id") for item in clusters), "Items should have cluster_id"
